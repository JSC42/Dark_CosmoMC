...
// Some fixed params for camb
#define Gamma_camb 0.0
#define Mbh_camb 1.0E14
#define fbh_camb 0.0
#define PBH_Distribution_camb 1.0
#define PBH_Lognormal_Sigma_camb 1.0
#define PBH_PWL_Mmax_camb 1.0E16
#define PBH_PWL_Gamma_camb 0.5
#define PBH_Spin_camb 0.0
